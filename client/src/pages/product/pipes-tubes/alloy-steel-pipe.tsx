  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium quality alloy steel pipes in grades P5, P9, P11, P22, P91, P92. ASTM A335 certified seamless pipes for high-temperature service. Power plant applications."
        keywords="alloy steel pipes, ASTM A335, P91 pipes, P22 pipes, high temperature pipes, power plant pipes, Mumbai steel supplier"
        category="Pipes & Tubes"
        productName="Alloy Steel Pipes"
