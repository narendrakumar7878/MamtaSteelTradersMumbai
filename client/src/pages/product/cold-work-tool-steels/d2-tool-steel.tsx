  ...
  return (
    <>
      <ProductSEO
        ...
        keywords="D2 tool steel, AISI D2 steel, 1.2379 tool steel, cold work tool steel, stamping dies, Mumbai D2 steel supplier"
        category="Cold Work Tool Steels"
        productName="D2 Tool Steel"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100" data-testid="hero-subtitle">
                High-carbon, high-chromium tool steel for stamping dies, blanking tools, and cold forming applications
              </p>
                ...
                <table className="w-full bg-white border border-gray-200 rounded-lg shadow-md" data-testid="composition-table">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">Forms hard wear-resistant carbides</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4 font-semibold">Molybdenum (Mo)</td>
                      <td className="px-6 py-4">0.70-1.20</td>
                      <td className="px-6 py-4">Increases hardenability and toughness</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4 font-semibold">Vanadium (V)</td>
                      <td className="px-6 py-4">1.10 Max</td>
                      <td className="px-6 py-4">Refines grain structure, wear resistance</td>
                    </tr>
                  </tbody>
                </table>
              </div>
