...
export default function D3ToolSteel() {
  const specifications = [
    ...
    "DIN 1.2080 - Cold Work Tool Steel Standard",
    "JIS SKD1 - Japanese Industrial Standard for Cold Work Tool Steel",
    "AISI D3 - Tool Steel Classification",
  ...
  const features = [
    { icon: Shield, title: "Superior Wear Resistance", desc: "Exceptional abrasion resistance due to high carbide content" },
    { icon: TrendingUp, title: "High Compressive Strength", desc: "Excellent compressive strength for heavy-duty applications" },
    { icon: Award, title: "Deep Hardening", desc: "Through-hardening capability for large cross-sections" },
    { icon: CheckCircle, title: "Minimal Distortion", desc: "Low distortion during heat treatment processes" }
  ];
  ...
  const properties = [
    {
      ...
      value: "2.00-2.35%",
      description: "Very high carbon for maximum hardness"
    },
    {
      property: "Chromium Content",
      value: "11.00-13.50%",
      description: "Forms extensive carbide network"
    },
    {
  ...
  return (
    <>
      <ProductSEO
        title="D3 Tool Steel"
        description="Premium quality D3 tool steel with superior wear resistance and high compressive strength. ASTM A681, DIN 1.2080 certified for blanking dies, drawing tools, and heavy-duty cold work applications. Best prices in Mumbai for D3 tool steel."
        keywords="D3 tool steel, AISI D3 steel, 1.2080 tool steel, cold work tool steel, blanking dies, Mumbai D3 steel supplier"
        category="Cold Work Tool Steels"
        productName="D3 Tool Steel"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="hero-title">
                Premium D3 Tool Steel
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-blue-100" data-testid="hero-subtitle">
                Ultra-high carbon tool steel with superior wear resistance for blanking dies, drawing tools, and heavy-duty cold work
              </p>
                ...
                <table className="w-full bg-white border border-gray-200 rounded-lg shadow-md" data-testid="composition-table">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">Ultra-high carbon for maximum hardness</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4 font-semibold">Chromium (Cr)</td>
                      <td className="px-6 py-4">11.00-13.50</td>
                      <td className="px-6 py-4">Forms extensive carbide network</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4 font-semibold">Silicon (Si)</td>
                      <td className="px-6 py-4">0.60 Max</td>
                      <td className="px-6 py-4">Deoxidizer and strength enhancer</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
