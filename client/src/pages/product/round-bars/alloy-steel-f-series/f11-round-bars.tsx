...
export default function F11RoundBars() {
  ...
  const applications = [
    ...
    "Furnace and Oven Components"
  ];

  const features = [
    { icon: Shield, title: "High Temperature Resistance", desc: "Excellent performance at temperatures up to 600°C" },
    { icon: TrendingUp, title: "Creep Resistance", desc: "Superior resistance to creep deformation at elevated temperatures" },
    { icon: Award, title: "ASME Approved", desc: "Meets ASME Boiler and Pressure Vessel Code requirements" },
    { icon: CheckCircle, title: "Oxidation Resistant", desc: "Good resistance to oxidation in high-temperature environments" }
  ];

  return (
    <>
      <ProductSEO
        title="F11 Round Bars (1.25Cr-0.5Mo)"
        description="Premium quality F11 alloy steel round bars with 1.25% chromium and 0.5% molybdenum. ASTM A182, A336 certified for high-temperature power plant and petrochemical applications. Best prices in Mumbai for F11 round bars."
        keywords="F11 round bars, 1.25Cr-0.5Mo steel bars, ASTM A182 F11, high temperature steel bars, power plant components, Mumbai F11 steel supplier"
        category="Round Bars"
        productName="F11 Round Bars (1.25Cr-0.5Mo)"
        ...
        <nav className="bg-white py-4 border-b border-gray-200" data-testid="breadcrumb-nav">
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-navy-primary font-medium" data-testid="breadcrumb-current">F11 Round Bars</span>
            </div>
          </div>
        </nav>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="hero-title">
                Premium F11 Round Bars
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-blue-100" data-testid="hero-subtitle">
                High-temperature resistant F11 (1.25Cr-0.5Mo) alloy steel round bars for power plant and petrochemical applications
              </p>
                ...
                <table className="w-full bg-white border border-gray-200 rounded-lg shadow-md" data-testid="composition-table">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">1.00 - 1.50</td>
                      <td className="px-6 py-4">High temperature oxidation resistance</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4 font-semibold">Molybdenum (Mo)</td>
                      <td className="px-6 py-4">0.44 - 0.65</td>
                      <td className="px-6 py-4">Creep strength and hardenability</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                    ...
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">Hardenability and strength</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6" data-testid="cta-title">
                Ready to Order F11 Round Bars?
              </h2>
              <p className="text-xl mb-8 text-blue-100" data-testid="cta-subtitle">
                Get instant quotes and technical support from our F11 alloy steel specialists
              </p>
