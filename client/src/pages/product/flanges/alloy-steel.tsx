...
export default function AlloySteelFlanges() {
  const specifications = [
    ...
    "Grades: F5, F9, F11, F22, F91, F92, F911"
  ];
  ...
  const materialGrades = [
    { grade: "F5", composition: "5Cr-0.5Mo", tempRange: "Up to 650°C" },
    { grade: "F9", composition: "9Cr-1Mo", tempRange: "Up to 650°C" },
    { grade: "F11", composition: "1.25Cr-0.5Mo", tempRange: "Up to 650°C" },
    { grade: "F22", composition: "2.25Cr-1Mo", tempRange: "Up to 650°C" },
    { grade: "F91", composition: "9Cr-1Mo-V", tempRange: "Up to 650°C" },
    { grade: "F92", composition: "9Cr-0.5Mo-1.8W-V-Nb", tempRange: "Up to 650°C" }
  ];
  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium alloy steel flanges in grades F5, F9, F11, F22, F91, F92. ASTM A182 certified for high-temperature service. Power plant applications from Mumbai steel supplier."
        keywords="alloy steel flanges, ASTM A182 flanges, F91 flanges, F22 flanges, high temperature flanges, power plant flanges, Mumbai steel supplier"
        category="Flanges"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="hero-title">
                Premium Alloy Steel Flanges
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-blue-100" data-testid="hero-subtitle">
                High-quality ASTM certified alloy steel flanges for high-temperature applications
              </p>
