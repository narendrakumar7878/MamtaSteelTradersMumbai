...
export default function InconelFlanges() {
  const specifications = [
    ...
    "Grades: 600, 601, 617, 625, 686, 690, 718, 725, X-750"
  ];
  ...
  const inconelGrades = [
    { grade: "Inconel 600", composition: "Ni-Cr-Fe", tempRange: "Up to 1100°C", application: "High Temperature Oxidation" },
    { grade: "Inconel 601", composition: "Ni-Cr-Al-Fe", tempRange: "Up to 1200°C", application: "High Temperature & Carburizing" },
    { grade: "Inconel 625", composition: "Ni-Cr-Mo-Nb", tempRange: "Up to 980°C", application: "Extreme Corrosion Resistance" },
    { grade: "Inconel 686", composition: "Ni-Cr-Mo-W", tempRange: "Up to 650°C", application: "Aggressive Chemical Environments" },
    { grade: "Inconel 718", composition: "Ni-Cr-Fe-Nb-Mo-Ti-Al", tempRange: "Up to 650°C", application: "High Strength Applications" }
  ];
  ...
  return (
    <>
      <ProductSEO
        ...
        description="Premium Inconel flanges in grades 600, 601, 625, 686, 718. ASTM B564 certified for high-temperature aerospace and chemical applications from Mumbai steel supplier."
        keywords="inconel flanges, ASTM B564 flanges, Inconel 625 flanges, Inconel 600 flanges, aerospace flanges, high temperature flanges, Mumbai steel supplier"
        category="Flanges"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="hero-title">
                Premium Inconel Flanges
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-blue-100" data-testid="hero-subtitle">
                High-quality ASTM certified Inconel flanges for aerospace and high-temperature applications
              </p>
