    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="py-16 bg-gray-50" data-testid="design-types-section">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-navy-primary mb-12" data-testid="design-types-title">
        ...
        <section className="py-16 bg-gray-50" data-testid="dimensions-section">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-navy-primary mb-12" data-testid="dimensions-title">
