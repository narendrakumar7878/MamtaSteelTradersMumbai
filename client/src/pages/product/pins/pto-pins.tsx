...
export default function PTOPins() {
  const specifications = [
    "ASTM A193 Grade B7 - High Tensile Alloy Steel Bolting Material",
    "ASTM A320 Grade L7 - Low Temperature Service Bolting Material",
    "ISO 898-1 - Property Classes for Bolts, Screws and Studs",
    "Material: High Tensile Steel, Stainless Steel",
    "Size Range: M6 to M64 diameter",
    "Length: 25mm to 500mm",
    "Thread: Metric Coarse and Fine Thread"
  ];
  ...
  const features = [
    { icon: Shield, title: "High Strength", desc: "Made from high tensile steel for maximum durability" },
    { icon: TrendingUp, title: "Precision Made", desc: "Manufactured to precise tolerances for perfect fit" },
    { icon: Award, title: "Quality Tested", desc: "ASTM and ISO certified for quality assurance" },
    { icon: CheckCircle, title: "Versatile Use", desc: "Suitable for various industrial and agricultural applications" }
  ];

  const sizeChart = [
    { diameter: "6mm", length: "25-100mm", load: "5 kN", material: "Steel/SS" },
    { diameter: "8mm", length: "30-120mm", load: "8 kN", material: "Steel/SS" },
    { diameter: "10mm", length: "35-150mm", load: "12 kN", material: "Steel/SS" },
    { diameter: "12mm", length: "40-180mm", load: "18 kN", material: "Steel/SS" },
    { diameter: "16mm", length: "50-250mm", load: "32 kN", material: "Steel/SS" },
    { diameter: "20mm", length: "60-300mm", load: "50 kN", material: "Steel/SS" }
  ];
  ...
  return (
    <>
      <ProductSEO
        title="PTO Pins"
        description="High-quality PTO pins and clevis pins ASTM A193 certified. Heavy duty pins for agricultural machinery and industrial equipment from Mumbai steel supplier."
        keywords="PTO pins, clevis pins, agricultural pins, heavy duty pins, ASTM A193 pins, machinery pins, Mumbai steel supplier"
        category="Pins"
        productName="PTO Pins"
        ...
        <nav className="bg-white py-4 border-b border-gray-200" data-testid="breadcrumb-nav">
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <ArrowRight className="w-4 h-4" />
              <span className="text-navy-primary font-medium" data-testid="breadcrumb-current">PTO Pins</span>
            </div>
          </div>
        </nav>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100" data-testid="hero-subtitle">
                High-quality ASTM certified PTO pins for agricultural and industrial machinery
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-navy-primary mb-12" data-testid="size-chart-title">
                Standard Sizes & Load Ratings
              </h2>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300 bg-white rounded-lg overflow-hidden shadow-md">
                  <thead className="bg-navy-primary text-white">
                    <tr>
                      <th className="border border-gray-300 px-4 py-3 text-left">Diameter</th>
                      <th className="border border-gray-300 px-4 py-3 text-left">Length Range</th>
                      <th className="border border-gray-300 px-4 py-3 text-left">Load Rating</th>
                  ...
                  <tbody>
                    {sizeChart.map((item, index) => (
                      <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                        ...
                        <td className="border border-gray-300 px-4 py-3">{item.length}</td>
                        <td className="border border-gray-300 px-4 py-3">{item.load}</td>
                        <td className="border border-gray-300 px-4 py-3">{item.material}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6" data-testid="cta-title">
                Ready to Order PTO Pins?
              </h2>
              <p className="text-xl mb-8 text-blue-100" data-testid="cta-subtitle">
                Get premium quality PTO pins with fast delivery across India
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
