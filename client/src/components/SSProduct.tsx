      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-6xl mx-auto leading-relaxed">
          ...
          >
            {steelCategories.map((category, index) => (
              <motion.article
                key={category.title}
                className={`${category.bgColor} ${category.borderColor} border-2 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300`}
                variants={fadeInUp}
                whileHover="hover"
                custom={index}
              >
                <div className="flex items-center mb-6">
                  ...
                  <h2 className={`text-3xl font-bold ${category.iconColor}`}>
                    {category.title}
                  </h2>
                </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-semibold text-[#0d2b4e] dark:text-blue-400 mb-4">
          ...
          {/* Call to Action */}
          <motion.div 
            className="text-center bg-gradient-to-r from-[#0d2b4e] to-[#1a3e72] rounded-2xl p-12 text-white shadow-2xl"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeInUp}
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/contact">
                <Button 
                  size="lg"
                  className="bg-[#f39c12] hover:bg-[#e97e07] text-white font-bold py-4 px-8 rounded-xl text-lg transition-all duration-300 hover:scale-105 shadow-lg"
              ...
              <Link href="/contact">
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-[#0d2b4e] font-bold py-4 px-8 rounded-xl text-lg transition-all duration-300"
