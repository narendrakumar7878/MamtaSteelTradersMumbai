      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center gap-4">
            <Button 
              className="bg-[#f39c12] text-white hover:opacity-90 hover:scale-105 px-5 py-2 rounded-xl font-semibold text-lg tracking-wide transition-all duration-300 shadow-lg hover:shadow-xl"
              data-testid="button-get-quote"
            >
              <Quote className="w-5 h-5 mr-3" />
              Get Instant Quote
            </Button>
            <div className="text-xs text-gray-200 mt-1" data-testid="badge-office-time">
