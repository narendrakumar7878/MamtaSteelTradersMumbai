      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center">
            <div className="w-20 h-20 bg-[#0d2b4e] rounded-lg flex items-center justify-center shadow-lg" data-testid="company-logo">
          ...
          <div className="text-center flex-1 max-w-xl">
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm lg:text-base font-medium text-gray-100">
                ...
                <div className="bg-[#0d2b4e] text-white px-4 py-2 rounded-full inline-block font-semibold" data-testid="badge-office-time">
          ...
          <div className="flex items-center">
            <Button 
              className="bg-[#f39c12] text-white hover:opacity-90 px-8 py-4 rounded-lg font-semibold text-lg tracking-wide transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
